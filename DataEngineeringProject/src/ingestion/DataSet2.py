...
def dataset_upload(airlines_dataset_name, csv_file_destination_path):
    try:
        kaggle.api.authenticate()
        # Kaggle API call to download the csv file to the csv_destination_path
        kaggle.api.dataset_download_files(airlines_dataset_name, csv_file_destination_path, unzip=True)
