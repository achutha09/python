...
CREATE PROCEDURE ss.PopulateDimensionTables
AS
BEGIN
...
select o.OrderID, o.UnitPrice,o.Quantity,o.Discount,ord.OrderDate,o.ProductID, ord.CustomerID, ord.ShipVia,ord.EmployeeID, sp.SupplierID,pp.CategoryID 
